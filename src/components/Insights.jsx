...
export default function Insights() {
  ...
  const momChange = (
    ((mar.expenses - feb.expenses) / feb.expenses) *
    100
  ).toFixed(1);
      ...
      <div className="insights-grid">
        <div className="insight-card" style={{ animationDelay: "0.05s" }}>
          ...
          <div
            ...
            style={{
              color: topCategory
                ? categoryColors[topCategory.name]
                : "var(--text)",
            }}
          >
            {topCategory?.name || "—"}
          ...
          <div className="insight-note">
            {topCategory
              ? `₹${topCategory.value.toLocaleString("en-IN")} total spent`
              : "No data"}
          </div>
        </div>
        ...
        <div className="insight-card" style={{ animationDelay: "0.1s" }}>
          ...
          <div
            className="insight-value"
            style={{
              color: Number(savingsRate) > 20 ? "var(--green)" : "var(--red)",
            }}
          >
            {savingsRate}%
          </div>
        ...
        <div className="insight-card" style={{ animationDelay: "0.15s" }}>
          ...
          <div className="insight-value">
            ₹{Number(dailyAvg).toLocaleString("en-IN")}
          </div>
        ...
        <div className="insight-card" style={{ animationDelay: "0.2s" }}>
          ...
          <div
            className="insight-value"
            style={{
              color: Number(momChange) > 0 ? "var(--red)" : "var(--green)",
              display: "flex",
              alignItems: "center",
              gap: 8,
            }}
          ...
          <div className="insight-note">
            {Number(momChange) > 0
              ? `Expenses up vs February`
              : `Expenses down vs February`}
          </div>
        </div>
      </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {topCategory && (
            ...
            >
              ...
              <div>
                ...
                >
                  Highest category: {topCategory.name}
                </div>
                <div style={{ fontSize: 12.5, color: "var(--text2)" }}>
                  You've spent ₹{topCategory.value.toLocaleString("en-IN")} on{" "}
                  {topCategory.name.toLowerCase()} — that's{" "}
                  {((topCategory.value / totalExpenses) * 100).toFixed(1)}% of
                  your total expenses.
                </div>
              </div>
            </div>
          ...
          {Number(momChange) > 10 && (
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: 12.5, color: "var(--text2)" }}>
                  Your expenses went up by {momChange}% compared to last month.
          ...
          <div
            style={{
              ...
              padding: "14px",
              background:
                Number(savingsRate) > 20 ? "var(--green-bg)" : "var(--red-bg)",
              borderRadius: 10,
            }}
          >
            <Target
